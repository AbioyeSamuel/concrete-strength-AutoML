...
# Import the MEPRegressor from your MEP library (ensure it is installed)
...
if __name__ == "__main__":
    ...
    ###############################################
    # Step 3: Symbolic Regression using Genetic Programming (MEP alternative)
    ###############################################
    ...
    print("Training Symbolic Regressor (MEP alternative)...")
    ...
    plt.fill_between(range(1, n_splits+1), cv_scores.mean()-cv_scores.std(), cv_scores.mean()+cv_scores.std(), color='red', alpha=0.2, label='Std Deviation Range')
