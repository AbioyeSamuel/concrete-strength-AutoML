...
# Import Lasso for reference (TPOT will auto-select it)
...
if __name__ == "__main__":
    ...
    ###############################################
    # Step 3: Automated Hyperparameter Tuning with TPOT using Lasso Regression
    ###############################################
    # Configure TPOT to search only over Lasso hyperparameters
    tpot_config = {
    ...
    print("Starting TPOT AutoML tuning for Lasso Regression...")
    tpot.fit(X_train_scaled, y_train)
    print("TPOT tuning complete.")

    best_model = tpot.fitted_pipeline_
    print("Best Lasso Model from TPOT:")
    print(best_model)
